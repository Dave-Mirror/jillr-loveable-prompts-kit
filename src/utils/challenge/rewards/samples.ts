...
export const getSampleRewards = (): UserReward[] => {
  return [
    ...
    },
    {
      ...
      type: 'access',
      imageUrl: 'https://images.unsplash.com/photo-1527866512907-61d64dc45a5d?q=80&w=500',
      unlocked: true,
      claimed: true,
    ...
    },
    {
      ...
      type: 'ticket',
      imageUrl: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=500',
      claimCode: 'VIPFEST24',
