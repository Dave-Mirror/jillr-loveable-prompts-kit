...
const EnterpriseDashboardContent = () => {
  const { user } = useAuth();
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        ...
        <TabsContent value="newCampaign">
          <div className="p-8 text-center bg-card rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold mb-4">Neue Kampagne erstellen</h3>
            <p className="text-muted-foreground mb-6">
              Nutze unseren Challenge-Editor, um eine neue Marketing-Kampagne für deine Zielgruppe zu erstellen.
            </p>
